...
$filter = $app->filter;
$filter->pseudofields['created_by']->user(4);
...
$filter->pseudofields['created_by']->user(array('user_id' => 5));
...
$filter->pseudofields['created_by']->user(new Chiara\PodioContact(array('user_id' => 6, 'profile_id' => 7)));
...
$filter->pseudofields['created_by']->me();
